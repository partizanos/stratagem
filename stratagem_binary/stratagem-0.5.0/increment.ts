...
t1 = { 
    Place(p1, suc($jeton_p1), Place(p2, $jeton_p2, Place(p3, $jeton_p3, $p))) 
    -> 
    Place(p1, suc($jeton_p1), Place(p2, $jeton_p2, Place(p3, $jeton_p3, $p))) 
}

t2 = { Place(p1, $jeton_p1, Place(p2, suc($jeton_p2), Place(p3, $jeton_p3, $p))) 
    -> Place(p1, $jeton_p1, Place(p2, $jeton_p2, Place(p3, $jeton_p3, $p)))  }
    // forced to write all state in all transition because p1 p2 p3 initial state definition, doens combine p1, p3
t3 = { Place(p1, suc($jeton_p1), Place(p2, $jeton_p2, Place(p3, $jeton_p3, $p))) 
    -> Place(p1, $jeton_p1, Place(p2, $jeton_p2, Place(p3, suc($jeton_p3), $p))) }
...
checkProp = {  
    Place(p1,  $jeton_p1, 
        Place(p2, zero, 
            Place(p3, $jeton_p3, noPlace))) 
    -> 
    Place(p1,  $jeton_p1, 
        Place(p2, suc(suc(zero)), 
            Place(p3, $jeton_p3, noPlace))) }
